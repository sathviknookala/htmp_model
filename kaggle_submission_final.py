"""
Final Ensemble Submission - Minimal dependencies
Ensemble of LightGBM + XGBoost with inline feature engineering
"""
import os
import sys
...
class FinalEnsemblePredictor:
    """Ensemble predictor with inline feature engineering"""
    ...
    def create_features(self, df):
        """
        Inline feature engineering - creates the same features as training
        This avoids pickle dependency issues
        """
        df = df.copy()
    ...
    def predict_allocation(self, test_row_pl: pl.DataFrame) -> float:
        ...
        try:
            ...
            # ULTRA-AGGRESSIVE allocation mapping for top 17%
            # Scale factor 0.0001 = 0.01% predicted return → full swing
            scale_factor = 0.0001  # Ultra-sensitive for top rankings!
...
def predict(test: pl.DataFrame) -> float:
    ...
    if predictor is None:
        print("=" * 70)
        print("INITIALIZING FINAL ENSEMBLE PREDICTOR")
        print("=" * 70)
